...
export class MyApp {
  ...
  constructor(public platform: Platform, public statusBar: StatusBar, public splashScreen: SplashScreen) {
    ...
    this.menu = [          

        {
          ...
          items:  [
              ...
              {name:'CRUD(create,read,update,delete)',component: 'FormResultPage'},
              ...
              {name:'Radio Station',component:'RadioListPage'},
    ...
    this.pages = [ 
      ...
      { icon:'bookmark', title:'Version 3.0', component: "MainPage" }    
    ];
