...
export class Detail1Page {
  ...
  constructor( 
    ...
    public ref: ChangeDetectorRef) {
      ...
      this.itemImages = afDB.list('/list/'+this.itemId+'/images' ).valueChanges();
      this.itemImages.subscribe( (value) => {
        this.imgGalleryArray = value; 
        console.log(this.imgGalleryArray);
