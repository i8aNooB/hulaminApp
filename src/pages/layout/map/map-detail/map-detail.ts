...
@ViewChild('map') mapElement: ElementRef;
  map: any;
  mapDetail: Observable<any>;
  mapDetailRef:  AngularFireObject<any>;
  //***********  Map style  **************//
  //*****  For more map styles    ********//
  ...
  constructor(
    ...
    // this.mapDetail = afDB.object("/map/"+this.mapId).valueChanges();
    // this.mapDetail.subscribe(snapshots => {
    //       this.image = snapshots.payload.val().image;
    //       this.title = snapshots.payload.val().title;
    //       this.description  = snapshots.payload.val().description;
    //       this.mapLat = snapshots.payload.val().lat;
    //       this.mapLng = snapshots.payload.val().lng;

    //       loadingPopup.dismiss();  
    //   });


    this.mapDetailRef = afDB.object("/map/"+this.mapId);
    this.mapDetailRef.snapshotChanges().subscribe(action => {
    
        this.image = action.payload.val().image;
        this.title = action.payload.val().title;
        this.description  = action.payload.val().description;
        this.mapLat = action.payload.val().lat;
        this.mapLng = action.payload.val().lng;
