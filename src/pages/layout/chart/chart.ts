...
export class ChartPage {
    ...
    chartData: number[] =  [];
    chartRef: AngularFireList<any>;
    chartList:  Observable<any[]>;
    chartListArray:any[];
    ...
    loadingPopup.present();      
        ...
        this.chartRef = afDB.list('chart');
        this.chartRef.snapshotChanges(['child_added'])
          .subscribe(actions => {
            this.chartListArray = actions; 
            actions.forEach(action => {
            //   console.log(action.type);
            //   console.log(action.key);
            //   console.log(action.payload.val().country);
                this.chartLabels.push(action.payload.val().country);
                console.log("this.chartLabels.push= "+action.payload.val().country);
                this.chartData.push(parseInt(action.payload.val().view));
                console.log("this.chartData.push= "+parseInt(action.payload.val().view));
            });
